...
func SetUpRouter() *gin.Engine {
	...
	r.POST("/promote/:id", middleware.AuthenticateUser(), controllers.HandleUserPromotion)
	r.POST("/tasks", middleware.AuthenticateUser(), controllers.CreateTask)
	r.PUT("/tasks/:id", middleware.AuthenticateUser(), controllers.UpdateTask)
	r.DELETE("/tasks/:id", middleware.AuthenticateUser(), controllers.DeleteTask)
